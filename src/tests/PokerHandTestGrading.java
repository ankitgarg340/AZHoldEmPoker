...
public class PokerHandTestGrading {
	...
	@Test
	public void testTiedHighCard() {
		PokerHand a = new PokerHand(D2, C3, D4, S6, D10);
		PokerHand b = new PokerHand(C2, C3, S4, D6, H10);
	...
	public void testRoyalFlush() {
		PokerHand a = new PokerHand(D6, D2, D3, D4, D5);
	...
	@Test
	public void testRoyalFlushVsHighCard() {
		PokerHand a = new PokerHand(DA, DK, DQ, DJ, D10);
		PokerHand b = new PokerHand(D2, D3, D4, D5, H7);
